...
-- Insert Sample Users
INSERT INTO users (uuid, username, email, hashed_password, bio, country) VALUES
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'default', 'john@example.com', '$2a$10$hashedpassword1', 'Very real human man', 'US');
