...
**Note:** The `user_uuid` field is optional. If provided, it must match the authenticated user. If not provided, it will be automatically extracted from the Service JWT by the backend.
